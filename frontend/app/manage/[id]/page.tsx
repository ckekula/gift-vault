    ...
    <div className="min-h-screen" style={{ background: "var(--color-cream-50)" }}>
      ...
      >
        <div className="max-w-2xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            {saved && <span className="text-xs text-[#2d7a52] font-semibold">✓ saved</span>}
            <SecurityBadge />
            <button
              onClick={buildShareLinks}
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-sm font-bold text-white transition-all active:scale-95"
      ...
      <main className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-3.5 rounded-2xl border-2 border-dashed border-[#f4a4b5] text-[#c45a76] font-bold text-sm hover:bg-[#fde8ec] transition-all"
        >
          <Plus size={16} />
